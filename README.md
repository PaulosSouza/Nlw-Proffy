<p align="center">
   <img src="./.github/Proffy.png" alt="Proffy" width="280"/>
</p>


> :rocket: Plataforma online feito para conectar professores e estudantes, feito na Next Level Week #2 @Rocketseat
...
<div style="display: flex; flex-direction: 'row'; justify-content: space-around;">
   ...
   <img src="./.github/mobile-list.jpeg" width="180">
   <img src="./.github/mobile-classes.jpeg" width="180">
</div>
...
```bash
# Clone o Repositoria
$ git clone https://github.com/PaulosSouza/Nlw-Proffy.git
```
### 📦 Rode a API
